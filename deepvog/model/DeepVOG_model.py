...
def decoding_block(
    X, filter_size, filters_num, layer_num, block_type, stage, s=1, X_jump=0, up_sampling=True
):
    ...
    for i in np.arange(layer_num) + 1:
        ...
        X_joined_input = BatchNormalization(axis=3, name=bn_name_base + "main_" + str(i))(
            X_joined_input
        )
        if i != layer_num:
